...
from dimos.core.global_config import ViewerBackend, global_config
...
def viz_module(
    ...
    match global_config.viewer_backend:
        case "foxglove":
            ...
            viz_module = autoconnect(foxglove_bridge(**foxglove_config))
        case "rerun":
            from dimos.visualization.rerun.bridge import rerun_bridge

            viz_module = autoconnect(rerun_bridge(**rerun_config))
        case "rerun-web":
            from dimos.visualization.rerun.bridge import rerun_bridge

            viz_module = autoconnect(rerun_bridge(viewer_mode="web", **rerun_config))
        case _:
            viz_module = autoconnect()
